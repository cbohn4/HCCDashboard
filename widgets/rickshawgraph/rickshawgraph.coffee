...
class Dashing.Rickshawgraph extends Dashing.Widget
  ...
  DIVISORS = [
      {number: 100000000000000000000000,  label: 'Ybps'},
      {number: 100000000000000000000,     label: 'Zbps'},
      {number: 100000000000000000,        label: 'Ebps'},
      {number: 1000000000000000,          label: 'Pbps'},
      {number: 1000000000000,             label: 'Tbps'},
      {number: 1000000000,                label: 'Gbps'},
      {number: 1000000,                   label: 'Mbps'},
      {number: 1000,                      label: 'Kbps'}
  ]
